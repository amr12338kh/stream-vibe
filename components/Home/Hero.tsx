...
const Hero = () => {
  return (
    <section className="relative min-h-screen w-full overflow-hidden before:absolute before:inset-0 before:bg-linear-to-b before:from-black-8/40 before:via-transparent before:to-black-8/90 before:z-10">
      <MoviesBackground />
      ...
      <div
        className="absolute bottom-20 z-20 w-full animate-fade-up"
        style={{
          left: "50%",
      ...
      <div className="absolute inset-0 bg-linear-to-t from-black-8/90 via-transparent to-black-8/40 z-15" />
    </section>
  );
};
